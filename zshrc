...
plugins=(encode64 helm terraform git aws brew svn mvn yarn pip node jsontools npm z zsh-autosuggestions docker docker-compose kubectl minikube gradle man nmap nvm history-substring-search zsh-completions zsh-syntax-highlighting kube-ps1)
